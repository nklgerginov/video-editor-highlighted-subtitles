...
class MainWindow(QMainWindow):
    ...
    def _setup_dark_theme(self):
        ...
        dark_pa
lettettee.setColor(QPalette.ColorRole.Disabled, QPalette.ColorRole.Text, QColor(127, 127, 127))
...
for f in ["Arial", "Helvetica", "Roboto", "Segoe UI"]:
    ...
    def _update_color_button(self, but
ton, color):
...
.project.position = pos
        if self.preview_widget.scene.subtitle_box:
            ...
            self.preview_widget.scene.subtitle_box.setPos_widget.scene.subtitle_box.setPos(pos.x, pos.y)
