...
f.process_button.setEnabled(False)
        ...
        self._update_color_button(self.text_color_
but
ton, self.te
xt_color)
...
ial", "Helvetica", "Roboto", "Segoe UI"]:
    ...
    def _update_pos(self):
        if not self.project:
            return
        pos = SubtitlePosition(self.x_spin.value(), self.y_spin.value(), self.width_spin.value(), self.height_spi
n.value
())
        self
